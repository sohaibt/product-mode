...
function _isLikelyTrivial(changes: string[], fullDiff: string): boolean {
  ...
  const trivialChangeCount = changes.filter(line => 
...
function _isSimpleTypo(a: string, b: string): boolean {
